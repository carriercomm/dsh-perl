...
I<example:>
	  ...
	  mtp22@front_end $ cat /util/beowulf/node_groups/ALL
...
I<example:>
	  ...
	  mtp22@front_end $ cat /util/beowulf/node_groups/linux
	  ...
	  mtp22@front_end $ cat /util/beowulf/node_groups/openbsd
...
The default value of BEOWULF_ROOT is /util/beowulf
...
B<dsh> was originally written by Jason Rappleye at the Center for
...
T. Piotrowski, with help from the OpenSSH manpage (ssh.1), version
